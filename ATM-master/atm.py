...
class SampleApp(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.frames = {}
        for F in (StartPage, MenuPage, WithdrawPage, upiWithdrawPage, DepositPage, Transferpage ,BalancePage):
...
class MenuPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        withdraw_button = tk.Button(button_frame,
                                                            ...
                                                            width=50,
                                                            height=5)
        withdraw_button.grid(row=4,column=0,pady=5)


        def upiwithdraw():
            controller.show_frame('upiWithdrawPage')
        ...
        transfer_button = tk.Button(button_frame,
                                                            text='Transfer',
                                                            command=transfer,
                                                            relief='raised',
                                                            borderwidth=3,
                                                            width=50,
                                                            height=5)
        transfer_button.grid(row=2,column=0,pady=5)
...
class upiWithdrawPage(tk.Frame):    
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent,bg='#3d3d5c')
        self.controller = controller
        heading_label = tk.Label(self,
        ...
        choose_amount_label = tk.Label(self,
                                                           text='Choose the amount you want to upiwithdraw',
                                                           font=('orbitron',13),
                                                           fg='white',
                                                           bg='#3d3d5c')
        choose_amount_label.pack()
        ...
        one_hundred_button = tk.Button(button_frame,
                                                       text='100',
                                                       command=lambda:upiwithdraw(100),
                                                       relief='raised',
                                                       borderwidth=3,
                                                       width=50,
                                                       height=5)
        ...
        two_hundred_button = tk.Button(button_frame,
                                                       text='200',
                                                       command=lambda:upiwithdraw(200),
                                                       relief='raised',
                                                       borderwidth=3,
                                                       width=50,
                                                       height=5)
        ...
        three_hundred_button = tk.Button(button_frame,
                                                       text='300',
                                                       command=lambda:upiwithdraw(300),
                                                       relief='raised',
                                                       borderwidth=3,
                                                       width=50,
                                                       height=5)
